...
# This file was *autogenerated* from the file idcm_sagemath_phase5.sage
from sage.all_cmdline import *   # import sage library

_sage_const_70 = Integer(70); _sage_const_1 = Integer(1); _sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_16 = Integer(16); _sage_const_3 = Integer(3); _sage_const_37 = Integer(37); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_12 = Integer(12); _sage_const_10 = Integer(10); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6)
...
PHI = (_sage_const_1  + math.sqrt(_sage_const_5 ))/_sage_const_2 
PHI_INV = PHI - _sage_const_1 
BETA = PHI_INV/_sage_const_2 
KAPPA = _sage_const_1 /_sage_const_16 ; KAPPA3 = KAPPA**_sage_const_3 

# ============================================================
# BUILD FAN + TORIC VARIETY (from Phase 2-4)
# ============================================================
print("\n1. Building fan + toric variety...")
ray_indices = list(range(_sage_const_37 ))  # 0-36
...
glsm_coord3 = [glsm[i, _sage_const_3 ] for i in range(glsm.nrows())]
charge_to_rays = {}
...
for ch in [_sage_const_12 , _sage_const_10 , _sage_const_9 , _sage_const_8 , _sage_const_7 , _sage_const_6 ]:
...
try:
    ...
    d0_sq = D[_sage_const_0 ] * D[_sage_const_0 ]
