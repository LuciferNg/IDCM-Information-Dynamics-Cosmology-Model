...
# This file was *autogenerated* from the file idcm_sagemath_phases234.sage
from sage.all_cmdline import *   # import sage library

_sage_const_70 = Integer(70); _sage_const_37 = Integer(37); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2)
import os, json, math
...
ray_indices = list(range(_sage_const_37 ))  # 0-36 are true fan rays
...
h11_cy = data["h11"]  # 36
h11_ambient = n_rays - _sage_const_4   # Picard number of toric variety
print(f"\n  h¹¹(CY) = {h11_cy}")
...
for i in range(n_facets):
    ...
    for p_idx in range(poly.npoints()):
        ...
        dist = poly.distances([_sage_const_0 ]*poly.dim())[i] if hasattr(poly, 'distances') else _sage_const_0 
...
h11_batyrev = poly.npoints() - _sage_const_4  - poly.nfacets()  # This is wrong formula
...
results["chow_ideal_ngens"] = int(chow_ideal.ngens()) if chow_ideal.ngens() else _sage_const_0 
