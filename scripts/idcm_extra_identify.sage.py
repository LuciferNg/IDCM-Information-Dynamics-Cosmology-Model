...
# This file was *autogenerated* from the file idcm_extra_identify.sage
from sage.all_cmdline import *   # import sage library

_sage_const_70 = Integer(70); _sage_const_37 = Integer(37); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_30 = Integer(30); _sage_const_36 = Integer(36); _sage_const_31 = Integer(31)
...
for idx in range(_sage_const_30 , _sage_const_36 ):  # Divisors 30-35 (non-GLSM candidates)
    prod = D[idx] * antiK
    try:
...
for idx in range(_sage_const_31 , _sage_const_36 ):
    print(f"\n   D_{idx} (ray {idx+1}, coord={tuple(int(c) for c in pts[idx+1])}):")
    pairs = []
    for j in range(_sage_const_31 , _sage_const_36 ):
        if j >= idx: continue
        try:
