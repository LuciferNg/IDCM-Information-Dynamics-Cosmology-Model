...
# This file was *autogenerated* from the file idcm_sagemath_phase5e.sage
from sage.all_cmdline import *   # import sage library

_sage_const_70 = Integer(70); _sage_const_1 = Integer(1); _sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_16 = Integer(16); _sage_const_3 = Integer(3); _sage_const_37 = Integer(37); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_12 = Integer(12); _sage_const_10 = Integer(10); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6)
import os, json, math
...
fan_pts = [vector(ZZ, pts[i]) for i in range(_sage_const_37 )]  # 37 fan rays
cones = []
for s in simps:
    non_origin = [i for i in s if i != _sage_const_0 ]
    if len(non_origin) == _sage_const_4 :
...
key_charges = [_sage_const_12 , _sage_const_10 , _sage_const_9 , _sage_const_8 , _sage_const_7 , _sage_const_6 ]
...
kappa = {}
try:
    for i in all_key_rays[:_sage_const_6 ]:
        prod_ii = D[i] * D[i]
        for j in all_key_rays[:_sage_const_6 ]:
            prod_ij = prod_ii * D[j]
            kappa_ij = X.integrate(prod_ij * antiK)
            kappa[(i,j)] = float(kappa_ij) if kappa_ij else _sage_const_0 
            if i <= j:
...
for c1 in key_charges:
    ...
    for c2 in key_charges[:c1+_sage_const_1 ]:
        r2 = charge_rays.get(c2, [])
        for c3 in key_charges[:c2+_sage_const_1 ]:
