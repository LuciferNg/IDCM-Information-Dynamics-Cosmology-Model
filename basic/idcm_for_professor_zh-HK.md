...
| $\beta$ | $\varphi^{-1}/2 \approx 0.309017$ | 最細分裂 |
| $M$ | $33$ | MERA RG 收斂步數 |
...
$\text{Ind}(L) = 48.0004$，Kähler 錐喺 32D toric basis 下全部為正。
...
Jarlskog 唔變量：$J = 3.45 \times 10^{-5}\ (12\%)$。
...
$e^{-48}$ 嚟源：$\text{Ind}(L) = 48$。$n=42$ KK 模態 = 暗物質。
