...
def load_des_sn5yr(use_sys=True):
    ...
    # Load covariance matrix (from original npz file - it's an inverse cov in upper triangular)
...
def chi2_sn5yr(model, Om, h):
    ...
    Analytical marginalization using Goliath et al. (2001) eq. A9-A12
    """
    ...
    # M marginalization (Goliath+2001)
